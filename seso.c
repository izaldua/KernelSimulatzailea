...
int main(int argc, char *argv[])
{
   ...
   pthread_t erl, tim1, tim2;


   if (pthread_create(&erl, NULL, &erlojua, NULL) != 0) // Hariak sortzeko momentuan existitzen badira dagoeneko, honek "errorea" bueltatuko du
       perror("Failed to create threads");
   if (pthread_create(&tim1, NULL, &timer1, NULL) != 0)
       perror("Failed to create threads");
